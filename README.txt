...
Taken from Linux kernel sources before it was removed from staging.
...
The software is a modified version of wlags49_h2 and wlags49_h25, which were
in the Linux kernel staging driver sources between version 2.6 and 3.17.

The staging drivers themselves were modified versions of wl_lkm_722_abg.tar.gz
from the Agere Systems website, adapted for Ubuntu 9.04.

Copied from linux/drivers/staging (commit 31cd921) by Laurence de Bruxelles <lfdebrux@gmail.com>
...
Agere Systems agreed to make this code available under the BSD license,
which is reproduced in LICENSE.txt. This driver is based on the 7.22
version.
